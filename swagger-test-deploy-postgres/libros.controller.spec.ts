...
describe('LibrosController', () => {
  ...
  /**
   * Libro de ejemplo utilizado en las pruebas.
   * @type {Libro}
   */
  ...
  /**
   * Servicio de libros simulado para las pruebas.
   */
  ...
  /**
   * Inicialización del módulo de pruebas antes de cada prueba.
   */
  beforeEach(async () => {
  ...
  /**
   * Pruebas para el método `create` del controlador.
   */
  describe('create', () => {
