    ...
    TypeOrmModule.forRootAsync({
      ...
      useFactory: async () => {
        try {
           ...
           * @description Indica si el entorno actual es producción. 
           */
          const isProduction = process.env.NODE_ENV === 'production';

          /**
           * @constant {boolean} sslEnabled
           * @description Indica si SSL está habilitado basándose en la variable de entorno.
           */
          ...
          if (isProduction) {
             ...
             * 
             * @returns {Object} Configuración para entorno de producción.
             */
             ...
             * 
             * @returns {Object} Configuración para entorno de desarrollo.
             */
          ...
          /**
           * @description Manejo de errores al configurar la conexión a la base de datos.
           * 
           * @param {Error} error - El error lanzado durante la configuración.
           * @throws {Error} Lanza un error si no se pudo establecer la conexión.
           */
